export const resolveENS = async (address: string): Promise<string> => {
  try {
    const response = await fetch(
      `https://api.etherscan.io/api?module=proxy&action=eth_call&to=0x3671aE578E63FdF66ad4F3E12CC0c0d71Ac7510C&data=0x691f3431000000000000000000000000${address.slice(2)}&apikey=S1IH9Y6MS44HNJXERBSBZHWX8I5C7VJ4FM`,
    );
    ...
    // Error handling for ENS resolution
  }
